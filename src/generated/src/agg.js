...
function process_msg(state, tags, msg) {
  ...
  return Stdlib__Result.bind(of_string(msg), (function (param) {
                ...
                if (idx < state.questions.length) {
                  Caml_array.set(arr, idx, param.answer);
                  console.log([
                        name,
                        arr
                      ]);
...
function transform(s) {
  ...
  const data_answers = Caml_array.make(s.questions.length, Belt__Belt_Array.make(0, ""));
  const data = {
  ...
  Stdlib__Hashtbl.iter((function (param, value) {
          Stdlib__Array.iteri((function (i, answer) {
                  ...
                  Caml_array.get(data_answers, i).push(answer);
                }), value);
        }), s.users);
  return data;
}
